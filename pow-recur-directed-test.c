...
{
  printf("\n%s\n", __func__  );
  UTST_ASSERT_FLOAT_EQ( pow_recur( 0.0, 1 ), 0.0000, 0.0001 );
  UTST_ASSERT_FLOAT_EQ( pow_recur( 0.0, 2 ), 0.0000, 0.0001 );
}
...
{
  printf("\n%s\n", __func__  );
  UTST_ASSERT_FLOAT_EQ( pow_recur( -5.0, 1 )/-5, 1.0, 0.0001 );
  UTST_ASSERT_FLOAT_EQ( pow_recur( -5.0, 2 )/25, 1.0, 0.0001 );
  UTST_ASSERT_FLOAT_EQ( pow_recur( -5.0, 3 )/-125, 1.0, 0.0001 );
  UTST_ASSERT_FLOAT_EQ( pow_recur( -5.0, 4 )/625, 1.0, 0.0001 );
  UTST_ASSERT_FLOAT_EQ( pow_recur( -5.0, 5 )/-3125, 1.0, 0.0001 );
}
//------------------------------------------------------------------------
...
{
  printf("\n%s\n", __func__  );
  UTST_ASSERT_FLOAT_EQ( pow_recur( -10.0, 0 ), 1.0, 0.0001 );
  UTST_ASSERT_FLOAT_EQ( pow_recur( 12.0, 0 ), 1.0, 0.0001 );
  UTST_ASSERT_FLOAT_EQ( pow_recur( 0.0, 0 ), 1.0, 0.0001 );
}
//------------------------------------------------------------------------
...
{
  printf("\n%s\n", __func__  );
  UTST_ASSERT_FLOAT_EQ( pow_recur( 2000000000, 1 )/2000000000, 1.0, 0.0001 );
  UTST_ASSERT_FLOAT_EQ( pow_recur( 44000, 2 )/1936000000, 1.0, 0.0001 );
  UTST_ASSERT_FLOAT_EQ( pow_recur( 1234, 3 )/1879080904, 1.0, 0.0001 );
}
//------------------------------------------------------------------------
// main
//------------------------------------------------------------------------
