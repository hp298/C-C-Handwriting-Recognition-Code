...
void test_case_2_simple_find()
{
  ...
  UTST_ASSERT_INT_EQ( vector_int_find( &vec, 0 ), 0);
...
// test_case_4_simple_push_back_v2
//------------------------------------------------------------------------
// 

void test_case_4_simple_push_back_v2()
{
  printf( "\n%s\n", __func__ );
  ...
  vector_int_push_back_v2( &vec, 0xbad22222 );
  UTST_ASSERT_INT_EQ( vector_int_size( &vec    ), 1          );
  UTST_ASSERT_INT_EQ( vector_int_at  ( &vec, 0 ), 0xbad22222 );
...
//------------------------------------------------------------------------
// test_case_5_push_back_v2
//------------------------------------------------------------------------
// 

void test_case_5_push_back_v2()
{
  printf( "\n%s\n", __func__ );
...
//------------------------------------------------------------------------
// test_case_6_push_back_v1
//------------------------------------------------------------------------
// 

void test_case_6_push_back_v1()
{
  printf( "\n%s\n", __func__ );
  ...
  // Push back some elements w/ v2 to leave space
  for ( int i = 0; i < 5; i++ )
    vector_int_push_back_v2( &vec, i );
    
  // push back v1 with space in vector  
  for ( int i = 5; i < 9; i++ )
    vector_int_push_back_v1( &vec, i );
  ...
  // Check size
  UTST_ASSERT_INT_EQ( vector_int_size( &vec ), 9 );
...
//------------------------------------------------------------------------
// test_case_8_at_specific
//------------------------------------------------------------------------
// 
void test_case_8_at_specific()
{
  printf( "\n%s\n", __func__ );
  ...
  // Push back some elements
  vector_int_push_back_v1( &vec, 12345 );
  vector_int_push_back_v1( &vec, 67890 );
...
int main( int argc, char** argv )
{
  ...
  if ( ( __n == 0 ) || ( __n == 4 ) ) test_case_4_simple_push_back_v2();
  if ( ( __n == 0 ) || ( __n == 5 ) ) test_case_5_push_back_v2();
  if ( ( __n == 0 ) || ( __n == 6 ) ) test_case_6_push_back_v1();
  if ( ( __n == 0 ) || ( __n == 7 ) ) test_case_7_at();
  if ( ( __n == 0 ) || ( __n == 8 ) ) test_case_8_at_specific();
